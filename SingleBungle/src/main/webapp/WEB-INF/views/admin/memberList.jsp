  ...
  <jsp:include page="sideMenu.jsp" />
            <div class="col-sm-9">
                ...
                <div class="float-right">
                    <button id="deleteBtn" class="btn btn-success">강퇴</button> 
    ...
    <jsp:include page="../common/footer.jsp"/>
     <script>
    $(function(){
			$("#memberList").attr('class','nav-link px-4 active bg-primary text-white shadow-sm rounded-pill');
	});
    ...
    $("#deleteBtn").on("click", function(){
    	var memberNoList = [];
           ...
           $.ajax({
				url : "${contextPath}/admin/deleteMember",
				data : {"memberNoList" : memberNoList},
    ...
    $("#recoverBtn").on("click", function(){
    	var memberNoList = [];
           ...
           $.ajax({
				url : "${contextPath}/admin/recoverMember",
				data : {"memberNoList" : memberNoList},
