...
public class MarketPageInfo {
	...
	public MarketPageInfo(int currentPage, int listCount) {
	...
	public MarketPageInfo(int currentPage, int listCount, int boardCategory) {
		this.currentPage = currentPage;
		this.listCount = listCount;
	...
	public MarketPageInfo(int currentPage, int listCount, int limit, int pagingBarSize, int boardCategory) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
