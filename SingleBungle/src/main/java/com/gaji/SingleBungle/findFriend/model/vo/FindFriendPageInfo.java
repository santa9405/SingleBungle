...
@Component
public class FindFriendPageInfo {
	...
	public FindFriendPageInfo() { }

	public FindFriendPageInfo(int currentPage, int listCount) {
		super();
	...
	public String toString() {
		return "FindFriendPageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
				+ ", pageSize=" + pageSize + ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage="
				+ endPage + ", categoryCd=" + categoryCd + "]";
	}
