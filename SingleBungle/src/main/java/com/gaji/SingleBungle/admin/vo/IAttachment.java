...
public class IAttachment {
	...
	public IAttachment(int fileNo, String filePath, String fileName, int parentBoardNo, int fileLevel) {
		super();
		this.fileNo = fileNo;
	...
	public IAttachment(String filePath, String fileName, int fileLevel, int parentBoardNo) {
		super();
		this.filePath = filePath;
		this.fileName = fileName;
		this.fileLevel = fileLevel;
